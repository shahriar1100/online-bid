            ...
            <div className="mb-11 text-sm">
              ...
              <div className="mt-6">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  {listing.propertyAddress && <li>Address: {listing.propertyAddress}</li>}
                  {listing.propertyCity && listing.propertyState && (
                    <li>
                      Location: {listing.propertyCity}, {listing.propertyState}
                    </li>
                  )}
                  {listing.propertyPincode && <li>Pincode: {listing.propertyPincode}</li>}
                  {listing.propertyCountry && <li>Country: {listing.propertyCountry}</li>}
                  ...
                  {listing.builtInYear && <li>Built Year: {listing.builtInYear}</li>}
                  {listing.furnishing && <li>Furnishing: {listing.furnishing}</li>}
                  {listing.ownershipType && <li>Ownership Type: {listing.ownershipType}</li>}
                  {listing.ownershipTitle && <li>Ownership Title: {listing.ownershipTitle}</li>}
                  {listing.ownershipStatus && <li>Ownership Status: {listing.ownershipStatus}</li>}
                  {listing.legalDescription && <li>Legal Description: {listing.legalDescription}</li>}
                  {listing.auctionType && <li>Auction Type: {listing.auctionType}</li>}
                  {listing.auctionPrice && <li>Auction Price: ${listing.auctionPrice}</li>}
                  {listing.auctionDate && <li>Inspection Date/Time: {formatStorageDateTimeForDisplay(listing.auctionDate)}</li>}
                  {/* {listing.expiry && <li>Expiry: {listing.expiry}</li>} */}
                  {listing.expiry && <li>Expiry:{listing.expiry.split(".")[0]}</li>}
                </ul>
              </div>
