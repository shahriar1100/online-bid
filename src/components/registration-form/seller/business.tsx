...
const step5Schema = z
  ...
  .refine(
    (data) =>
      data.franchise !== "Yes" ||
      (data.namefranchise && data.namefranchise.trim().length > 0),
    {
...
export default function BusinessRegistrationForm({
          ...
          if (matchedState) {
            ...
            setTimeout(() => {
              const matchedCity = cities.find(
                (c) => c.name === data.businessCity,
              );
              if (matchedCity) {
                setValue("businessCity", matchedCity.name);
                const legacyCountry = locationData.countries.find(
                  (lc) => lc.name === data.businessCountry,
                );
                const legacyState = legacyCountry?.states.find(
                  (ls) => ls.name === data.businessState,
                );
                const legacyCity = legacyState?.cities.find(
                  (lc) => lc.name === data.businessCity,
                );
                setValue(
                  "businessPincode",
                  legacyCity?.pincode || data.businessPincode || "",
                );
              }
            }, 100);
          }
  ...
  const onSubmit = async (
    data: FormData,
  ): Promise<{ success: boolean; showingModal?: boolean } | void> => {
    setIsLoading(true);
    try {
      ...
      const payload = {
        ...
        businessAddress:
          data.businessAddress || adDetails?.businessAddress || "",
        businessCountry:
          data.businessCountry || adDetails?.businessCountry || "",
        businessState: data.businessState || adDetails?.businessState || "",
        businessCity: data.businessCity || adDetails?.businessCity || "",
        businessPincode:
          data.businessPincode || adDetails?.businessPincode || "",
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_WRANGLER_API_URL}/api/business${isSellerUpdatePage ? "/" + adDetails?.id : ""}`,
        {
          ...
          <div className="space-y-0">
            <div className="register-popup-subcontainer2 mb-6">
              ...
              <div>
                ...
                />
                {errors.auctionType && (
                  <p className="error-text">{errors.auctionType.message}</p>
                )}
              </div>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      onValueChange={(value: string) => {
                        field.onChange(value);
                        if (errors.businessCountry)
                          clearErrors("businessCountry");
                      }}
                    >
                      <SelectTrigger
                        className={`custom-input ${errors.businessCountry ? "border-red-500" : ""}`}
                      >
              ...
              <div className="cont">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger
                        className={`custom-input ${errors.businessState ? "border-red-500" : ""}`}
                      >
                ...
                {errors.businessState && (
                  <p className="error-text">{errors.businessState.message}</p>
                )}
              </div>
              <div className="cont">
                <Label className="custom-label mt-3">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger
                        className={`custom-input ${errors.businessCity ? "border-red-500" : ""}`}
                      >
                ...
                />
                {errors.businessCity && (
                  <p className="error-text">{errors.businessCity.message}</p>
                )}
              </div>
              <div className="cont">
          ...
          <div className="space-y-6">
            <div className="flex justify-start items-start flex-wrap gap-4">
              <div className="cont">
                ...
                />
                {errors.highlight && (
                  <p className="error-text">{errors.highlight.message}</p>
                )}
              </div>
              <div className="cont">
                <Label className="custom-label mt-3">
          ...
          <div className="space-y-6">
            <div className="register-popup-subcontainer">
              ...
              <div className="cont">
                ...
                />
                {errors.revenue && (
                  <p className="error-text">{errors.revenue.message}</p>
                )}
              </div>
              <div className="cont">
                <Label className="custom-label">
                  Annual profit/EBITDA<span className="text-red-500">*</span>
                  (Dollar)
                </Label>
                <Controller
                  name="profit"
                ...
                />
                {errors.profit && (
                  <p className="error-text">{errors.profit.message}</p>
                )}
              </div>
            </div>
            <div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <textarea
                    ...
                    {...field}
                    placeholder=""
                    className={`w-full h-34 p-3 border rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.assets ? "border-red-500" : "border-gray-300"
                    }`}
                    onChange={(e) => {
                      field.onChange(e);
              ...
              />
              {errors.assets && (
                <p className="error-text">{errors.assets.message}</p>
              )}
            </div>
            <div className="register-popup-subcontainer">
              <div className="cont">
                ...
                />
                {errors.inventory && (
                  <p className="error-text">{errors.inventory.message}</p>
                )}
              </div>
          ...
          <div className="space-y-6">
            <div className="register-popup-subcontainer">
              <div className="cont">
                ...
                />
                {errors.employes && (
                  <p className="error-text">{errors.employes.message}</p>
                )}
              </div>
              <div className="cont">
                <Label className="custom-label">
                ...
                />
                {errors.involvement && (
                  <p className="error-text">{errors.involvement.message}</p>
                )}
              </div>
              <div className="cont">
                <Label className="custom-label">
                ...
                />
                {errors.relocatable && (
                  <p className="error-text">{errors.relocatable.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="cont">
              ...
              />
              {errors.homebase && (
                <p className="error-text">{errors.homebase.message}</p>
              )}
            </div>
            <div className="register-popup-subcontainer">
              <div className="cont">
                ...
                />
                {errors.franchise && (
                  <p className="error-text">{errors.franchise.message}</p>
                )}
              </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        onChange={(e) => {
                          field.onChange(e);
                          if (errors.namefranchise)
                            clearErrors("namefranchise");
                        }}
                      />
                    )}
                  />
                  {errors.namefranchise && (
                    <p className="error-text">{errors.namefranchise.message}</p>
                  )}
                </div>
              )}
            </div>
          ...
          <div className="space-y-6">
            <div className="flex justify-start items-start gap-4 flex-wrap md:flex-nowrap">
              <div className="cont">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="hospitality">
                          Hospitality & Leisure Premises
                        </SelectItem>
                        <SelectItem value="mixed">
                          Mixed-use Premises
                        </SelectItem>
                        <SelectItem value="specialized">
                          Other Specialized Premises
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  )}
                />
                {errors.premises && (
                  <p className="error-text">{errors.premises.message}</p>
                )}
              </div>

              {auctionType === "lease" && (
                <div className="cont">
                  <Label className="custom-label">Monthly (if leased)</Label>
                  <Controller
                    name="monthly"
                    control={control}
                    render={({ field }) => (
                  ...
                  />
                  {errors.monthly && (
                    <p className="error-text">{errors.monthly.message}</p>
                  )}
                </div>
              )}
            ...
            <div className="cont">
              ...
              />
              {errors.facilitysize && (
                <p className="error-text">{errors.facilitysize.message}</p>
              )}
            </div>
          </div>
        )}
