...
export default function RealStateRegistrationForm({
  onClose,
  preselectedCategory,
  data,
          ...
          if (matchedState) {
            ...
            setTimeout(() => {
              ...
              if (matchedCity) {
                ...
                const legacyState = legacyCountry?.states.find(
                  (ls) => ls.name === data.propertyState,
                );
                const legacyCity = legacyState?.cities.find(
                  (lc) => lc.name === data.propertyCity,
                );
                setValue(
                  "propertyPincode",
                  legacyCity?.pincode || data.propertyPincode || "",
                );
              }
            }, 100);
          }
    ...
    try {
      ...
      if (data.registrationType === "new") {
        ...
        const signupResponse = await fetch(
          `${process.env.NEXT_PUBLIC_WRANGLER_API_URL}/auth/signup`,
          {
            method: "POST",
      ...
      const payload = {
        ...
        ownershipstatus:
          data.ownershipstatus || adDetails?.ownershipStatus || "",
        legalDescription:
          data.legalDescription || adDetails?.legalDescription || "",
        ...
        authorizedToSell:
          Boolean(data.authorizedToSell) ||
          Boolean(adDetails?.authorizedToSell) ||
          false,
        agreeTerms:
...
console.log("PAYLOAD =", payload);
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_WRANGLER_API_URL}/api/realestate${isSellerUpdatePage ? "/" + adDetails?.id : ""}`,
        {
  ...
  return (
    <form
      className="registration-form-seller"
      noValidate
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      onValueChange={(value: string) => {
                        field.onChange(value);
                        if (errors.propertyCountry)
                          clearErrors("propertyCountry");
                      }}
                    >
                      <SelectTrigger
                        className={`custom-input ${errors.propertyCountry ? "border-red-500" : ""}`}
                      >
              ...
              <div className="cont">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger
                        className={`custom-input ${errors.propertyState ? "border-red-500" : ""}`}
                      >
              ...
              <div className="cont">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger
                        className={`custom-input ${errors.propertyCity ? "border-red-500" : ""}`}
                      >
                ...
                />
                {errors.propertyCity && (
                  <p className="error-text">{errors.propertyCity.message}</p>
                )}
              </div>
              <div className="cont">
            ...
            {watchedSubcategory === "Vacant land" ? (
              ...
              <div className="register-popup-subcontainer">
                ...
                <div className="cont">
                  ...
                  />
                  {errors.lot_size && (
                    <p className="error-text">{errors.lot_size.message}</p>
                  )}
                </div>
                <div className="cont">
                  <Label className="custom-label">
              ...
              <>
                <div className="register-popup-subcontainer">
                  <div className="cont">
                    ...
                    />
                    {errors.bedroom && (
                      <p className="error-text">{errors.bedroom.message}</p>
                    )}
                  </div>
                  <div className="cont">
                    <Label className="custom-label">Bathroom</Label>
                    <Controller
                      name="bathroom"
                      control={control}
                      render={({ field }) => (
                    ...
                    />
                    {errors.bathroom && (
                      <p className="error-text">{errors.bathroom.message}</p>
                    )}
                  </div>
                  <div className="cont">
                    <Label className="custom-label">
                      Floor area<span className="text-red-500">*</span> (Sq.
                      ft.)
                    </Label>
                    <Controller
                      name="area"
                ...
                <div className="register-popup-subcontainer">
                  ...
                  <div className="cont">
                    <Label className="custom-label">Furnishing</Label>
                    <Controller
                      name="furnishing"
                      control={control}
                      render={({ field }) => (
                        ...
                        >
                          <SelectTrigger
                            className={`custom-input ${errors.furnishing ? "border-red-500" : ""}`}
                          >
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.auctionPrice && (
                  <p className="error-text">{errors.auctionPrice.message}</p>
                )}
              </div>
              <div className="cont">
                <Label className="custom-label">
                ...
                <Dialog
                  open={aisCalendarOpen}
                  onOpenChange={asetIsCalendarOpen}
                >
                  <DialogTrigger asChild>
                    <Button
                      type="button"
                      ...
                      className={`custom-input input-calender ${
                        errors.auctionDate ? "border-red-500" : ""
                      }`}
                      onClick={() => asetIsCalendarOpen(true)}
                    >
                      {aselectedDate
                        ? formatForDisplay(aselectedDate, aselectedTime)
                        : "Add time/days"}
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="custom-dialog-content">
                ...
                {errors.auctionDate && (
                  <p className="error-text">{errors.auctionDate.message}</p>
                )}
              </div>
            </div>
          </div>
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        field.onChange(textOnly);
                        if (errors.ownershiptitle)
                          clearErrors("ownershiptitle");
                      }}
                    />
                  )}
                />
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="cont">
                ...
                />
                {errors.isAgent && (
                  <p className="error-text">{errors.isAgent.message}</p>
                )}
              </div>
              ...
              <div className="space-y-6">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Checkbox
                        ...
                        onCheckedChange={(e) => {
                          field.onChange(e);
                          if (errors.authorizedToSell)
                            clearErrors("authorizedToSell");
                        }}
                      />
                    )}
                  />
                ...
                {errors.authorizedToSell && (
                  <p className="error-text">
                    {errors.authorizedToSell.message}
                  </p>
                )}
                {errors.agreeTerms && (
