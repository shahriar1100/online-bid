...
import { automobilefeature } from "src/app/data"
...
export default function Automobilefeature() {
  ...
  useEffect(() => {
    ...
    automobilefeature.forEach((listing) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {automobilefeature.slice(0, 8).map((listing) => {
