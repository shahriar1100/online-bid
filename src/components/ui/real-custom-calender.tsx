...
const DateTimePicker: React.FC<DateTimePickerProps> = ({
  ...
  const [localSelectedMinute, setLocalSelectedMinute] = useState(
    selectedTime ? selectedTime.split(":")[1] : "00",
  );
  const [localSelectedPeriod, setLocalSelectedPeriod] = useState<"AM" | "PM">(
    initTime.period,
  );
      ...
      <div className="my-6 pt-4 border-t">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="w-full">
            ...
            <Select
              value={localSelectedHour}
              onValueChange={setLocalSelectedHour}
            >
              <SelectTrigger
          ...
          <div className="w-full">
            ...
            <Select
              value={localSelectedMinute}
              onValueChange={setLocalSelectedMinute}
            >
              <SelectTrigger
                className="w-full rounded text-black dark:text-white"
                id="minute-select"
          ...
          <div className="w-full">
            ...
            <Select
              ...
              onValueChange={(val) =>
                setLocalSelectedPeriod(val as "AM" | "PM")
              }
            >
              <SelectTrigger
                className="w-full rounded text-black dark:text-white"
