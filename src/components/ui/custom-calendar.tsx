...
const DateRangePicker: React.FC<DateRangePickerProps> = ({
  ...
  const [localStartMinute, setLocalStartMinute] = useState(
    startTime ? startTime.split(":")[1] : "00",
  );
  const [localStartPeriod, setLocalStartPeriod] = useState<"AM" | "PM">(
    initStart.period,
  );

  const [localEndHour, setLocalEndHour] = useState(initEnd.hour);
  const [localEndMinute, setLocalEndMinute] = useState(
    endTime ? endTime.split(":")[1] : "00",
  );
  const [localEndPeriod, setLocalEndPeriod] = useState<"AM" | "PM">(
    initEnd.period,
  );
  ...
  const isInRange = (date: Date | null): boolean => {
    ...
    return (
      dateTime >= localStartDate.getTime() && dateTime <= localEndDate.getTime()
    );
  };
    ...
    <div className="p-4 bg-white dark:bg-black rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-7 text-center text-sm text-gray-500 mb-2">
        {dayNames.map((day) => (
          <div
            key={day}
            className="font-medium w-10 h-8 flex items-center justify-center"
          >
            {day}
          </div>
        ))}
      ...
      <div className="grid grid-cols-7 gap-1 text-sm">
        {days.map((day, index) => {
          ...
          const isStartDate =
            localStartDate &&
            date &&
            date.toDateString() === localStartDate.toDateString();
          const isEndDate =
            localEndDate &&
            date &&
            date.toDateString() === localEndDate.toDateString();
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={setLocalStartHour}
                >
                  <SelectTrigger
              ...
              <div>
                ...
                <Select
                  value={localStartMinute}
                  onValueChange={setLocalStartMinute}
                >
                  <SelectTrigger
                    className="w-full rounded text-black dark:text-white"
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setLocalStartPeriod(val as "AM" | "PM")
                  }
                >
                  <SelectTrigger
                    className="w-full rounded text-black dark:text-white"
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={setLocalEndMinute}
                >
                  <SelectTrigger
                    className="w-full rounded text-black dark:text-white"
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) => setLocalEndPeriod(val as "AM" | "PM")}
                >
                  <SelectTrigger
                    className="w-full rounded text-black dark:text-white"
